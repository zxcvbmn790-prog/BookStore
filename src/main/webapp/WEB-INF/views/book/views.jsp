						...
						<div style="max-width: 1200px; margin: 0 auto;">
							...
							<div class="section-header">
								<h2>초보자를 위한 컴퓨터 책</h2><a
									href="${pageContext.request.contextPath}/book/list?category=초보자를 위한 컴퓨터 책"
									class="more-link">더보기 ></a>
							</div>
							<div class="book-list-container">
							...
							<div class="section-header">
								<h2>경영전략/혁신 트렌드</h2><a
									href="${pageContext.request.contextPath}/book/list?category=경영전략/혁신"
									class="more-link">더보기 ></a>
							</div>
							<div class="book-list-container">
									...
									<div class="list-item">
										...
										<div class="list-btn-box">
											<button type="button" class="list-btn cart-btn"
												onclick="addCartAsync('${book.isbn}', '${sessionScope.loginUser}')">장바구니</button>
