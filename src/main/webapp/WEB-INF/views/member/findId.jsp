...
<section class="auth-page">
    <div class="auth-card">
        <div class="auth-top">
            <span class="section-badge">FIND ID</span>
            <h2>아이디를 잊으셨나요?</h2>
        </div>
        ...
        <div id="resultBox" class="result-box">
            <p style="margin:0; color:#166534;">회원님의 아이디는 다음과 같습니다.</p>
            <div class="found-id" id="foundUsername"></div>
...
function verifyOtp() {
    ...
    $.ajax({
        url: ctx + "/member/findId/verifyOtp",
        type: "POST",
        data: { otp: otp },
        success: function(res) {
            clearInterval(timerInterval);
            $("#formArea").hide();
            $("#foundUsername").text(res.username);
